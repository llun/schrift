...
enum L10nKey: String, CaseIterable, Sendable {
    ...
    case editor_attachment_pending = "editor.attachment_pending"  // "Waiting to upload"
    ...
    case editor_sync_pending_sync = "editor.sync.pending_sync"  // "Saved on this device · syncs when online"
    ...
    // Editor - sync conflict (detect & ask)
    case editor_conflict_pill = "editor.conflict.pill"  // "Sync conflict · tap to review"
    case editor_conflict_pill_a11y = "editor.conflict.pill_a11y"  // "Sync conflict. Tap to review."
    ...
    case editor_conflict_keep_server_detail = "editor.conflict.keep_server_detail"
    // "Discards the changes on this device"
    case editor_conflict_restore_hint = "editor.conflict.restore_hint"
    // "Overwritten versions can be restored from version history on the web."
