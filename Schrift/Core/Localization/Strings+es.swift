...
enum Strings_es {
    static let table: [L10nKey: String] = [
        ...
        .editor_attachment_pending: "Esperando para subir",
        .editor_attachment_pending_a11y: "Foto esperando para subir",
        .editor_attachment_failed: "No se pudo subir esta foto.",
        .editor_attachment_missing: "Esta foto ya no está en este dispositivo.",
        .editor_attachment_unattributable:
            "Esta foto aparecerá cuando este dispositivo sepa con qué cuenta has iniciado sesión.",
        .editor_attachment_retry: "Reintentar",
        .editor_attachment_remove: "Eliminar",
        ...
        .editor_attachment_downloading: "Descargando…",
        ...
        .editor_error_add_file: "No se pudo añadir el archivo. Inténtalo de nuevo.",
        .editor_error_file_too_large: "Ese archivo es demasiado grande.",
        .editor_slash_file: "Archivo",
        .editor_uploading_file: "Subiendo archivo…",
        .editor_uploading_file_a11y: "Subiendo archivo",
        ...
        .profile_prefs_footer:
            "Cuando está activado, los documentos que has abierto se pueden leer y editar en este dispositivo sin conexión.",
        ...
        .account_section_signin: "Inicio de sesión",
