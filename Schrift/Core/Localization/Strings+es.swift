...
enum Strings_es {
    static let table: [L10nKey: String] = [
        ...
        .home_filter_shared: "Compartidos",
        .home_filter_pinned: "Fijados",
        .home_section_pinned: "Fijados",
        .home_section_recent: "Recientes",
        .home_section_shared: "Compartido conmigo",
        ...
        .options_error_duplicate: "No se pudo duplicar el documento. Inténtalo de nuevo.",
        ...
        .editor_tree_close: "Cerrar páginas",
