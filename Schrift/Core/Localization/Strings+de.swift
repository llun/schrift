...
enum Strings_de {
    static let table: [L10nKey: String] = [
        ...
        .home_filter_shared: "Geteilt",
        .home_filter_pinned: "Angeheftet",
        .home_section_pinned: "Angeheftet",
        .home_section_recent: "Zuletzt",
        .home_section_shared: "Mit mir geteilt",
        ...
        .home_pin: "Anheften",
        .home_unpin: "Nicht mehr anheften",
        .home_dismiss_error: "Fehler ausblenden",
        .home_document_options: "Dokumentoptionen",
        ...
        .home_error_favorite: "Favorit konnte nicht aktualisiert werden. Bitte versuche es erneut.",
        ...
        .docrow_more_options: "Weitere Optionen",
        ...
        .editor_tree_pages: "Seiten",
        .editor_tree_close: "Seiten schließen",
        .editor_tree_empty: "Noch keine Unterseiten. Füge eine hinzu, um dieses Dokument zu organisieren.",
        .editor_tree_new_page: "Neue Seite",
