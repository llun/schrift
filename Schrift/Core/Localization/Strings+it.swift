...
enum Strings_it {
    static let table: [L10nKey: String] = [
        ...
        .editor_attachment_pending: "In attesa di caricamento",
        ...
        .editor_error_add_file: "Impossibile aggiungere il file. Riprova.",
        .editor_error_file_too_large: "Questo file è troppo grande.",
        .editor_slash_file: "File",
        .editor_uploading_file: "Caricamento del file…",
        .editor_uploading_file_a11y: "Caricamento del file",
        ...
        .editor_checklist_state_not_done_a11y: "Non completato",
        ...
        .profile_live_collaboration: "Collaborazione dal vivo",
        .profile_live_collaboration_footer:
            "La collaborazione dal vivo sincronizza le modifiche con gli altri in tempo reale quando il server la supporta.",
        ...
        .account_section_profile: "Profilo",
        .account_full_name: "Nome completo",
        .account_section_signin: "Accesso",
