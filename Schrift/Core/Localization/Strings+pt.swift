...
enum Strings_pt {
    static let table: [L10nKey: String] = [
        ...
        .home_filter_shared: "Partilhados",
        .home_filter_pinned: "Fixados",
        .home_section_pinned: "Fixados",
        .home_section_recent: "Recentes",
        .home_section_shared: "Partilhados comigo",
        ...
        .home_pin: "Fixar",
        .home_unpin: "Desafixar",
        .home_dismiss_error: "Ignorar erro",
        .home_document_options: "Opções do documento",
        ...
        .home_error_favorite: "Não foi possível atualizar o favorito. Tente novamente.",
        ...
        .docrow_more_options: "Mais opções",
        ...
        .options_copy_markdown: "Copiar como Markdown",
        .options_duplicate: "Duplicar",
        ...
        .options_error_duplicate: "Não foi possível duplicar o documento. Tente novamente.",
        ...
        .editor_tree_pages: "Páginas",
        .editor_tree_close: "Fechar páginas",
        .editor_tree_empty: "Ainda não há subpáginas. Adicione uma para organizar este documento.",
        .editor_tree_new_page: "Nova página",
