...
enum Strings_pt {
    static let table: [L10nKey: String] = [
        ...
        .docrow_pending_delete: "A aguardar eliminação",

        .pending_delete_alert_message: "Este documento será eliminado assim que for possível contactar o servidor.",

        .pending_delete_undo: "Manter este documento",

        .docrow_on_this_device: "Neste dispositivo, aguardando sincronização",
        ...
        .options_delete_confirm_subpages: "As subpáginas guardadas neste dispositivo serão eliminadas com ele.",
        ...
        .options_move: "Mover",
        .move_title: "Mover para",
        .move_home: "Início (nível superior)",
        .move_destinations: "Documentos",
        .move_empty: "Nenhum destino disponível.",
        .move_error: "Não foi possível mover o documento. Tente novamente.",
        .move_error_load: "Não foi possível carregar os destinos. Tente novamente.",
        ...
        .editor_attachment_pending: "Aguardando envio",
        .editor_attachment_pending_a11y: "Foto aguardando envio",
        .editor_attachment_failed: "Não foi possível enviar esta foto.",
        .editor_attachment_missing: "Esta foto já não está neste dispositivo.",
        .editor_attachment_unattributable:
            "Esta foto aparecerá assim que este dispositivo souber em que conta iniciou sessão.",
        .editor_attachment_retry: "Tentar novamente",
        .editor_attachment_remove: "Remover",
        ...
        .editor_sync_pending_sync: "Guardado neste dispositivo · sincroniza quando estiver online",
        ...
        .editor_conflict_pill: "Conflito de sincronização · toque para revisar",
        .editor_conflict_pill_a11y: "Conflito de sincronização. Toque para revisar.",
        .editor_conflict_title: "Conflito de sincronização",
        .editor_conflict_body:
            "Este documento foi alterado em outro lugar enquanto suas edições aguardavam sincronização. Escolha qual versão manter.",
        .editor_conflict_server_changed: "A cópia do servidor foi alterada %@.",
        .editor_conflict_keep_mine: "Manter a minha versão",
        .editor_conflict_keep_mine_detail: "Substitui a cópia do servidor",
        .editor_conflict_keep_server: "Manter a versão do servidor",
        .editor_conflict_keep_server_detail: "Descarta as alterações neste dispositivo",
        .editor_conflict_restore_hint:
            "As versões substituídas podem ser restauradas pelo histórico de versões na web.",

        // Editor - errors
        .editor_pending_delete: "Este documento está a aguardar eliminação.",
        ...
        .editor_image_external: "Imagem externa · Toque para carregar",
        .editor_image_external_a11y: "Imagem externa de %@. Toque para carregar.",
        .editor_attachment_downloading: "A transferir…",
        .editor_attachment_failed_retry: "Falha na transferência · Toque para tentar de novo",
        .editor_attachment_offline: "Disponível quando estiver online",
        .editor_attachment_a11y: "Anexo: %@. %@",
        .editor_attachment_not_previewable: "Não pode ser pré-visualizado aqui",
        .editor_error_add_file: "Não foi possível adicionar o ficheiro. Tente novamente.",
        .editor_error_file_too_large: "Esse ficheiro é demasiado grande.",
        .editor_slash_file: "Ficheiro",
        .editor_uploading_file: "A carregar ficheiro…",
        .editor_uploading_file_a11y: "A carregar ficheiro",
        ...
        .profile_live_collaboration: "Colaboração ao vivo",
        .profile_live_collaboration_footer:
            "A colaboração ao vivo sincroniza suas edições com outras pessoas em tempo real quando seu servidor oferece suporte.",
        ...
        // Account screen
        .account_title: "Conta",
        .account_section_profile: "Perfil",
        .account_full_name: "Nome completo",
        .account_section_signin: "Login",
        .account_signin_footer:
            "Você está conectado com sua sessão web. O Schrift se conecta usando o cookie do navegador e nunca armazena sua senha.",
        .account_email: "E-mail",
        .account_manage_on_web: "Gerenciar conta na web",
