...
enum Strings_fr {
    static let table: [L10nKey: String] = [
        ...
        .home_filter_shared: "Partagés",
        .home_filter_pinned: "Épinglés",
        .home_section_pinned: "Épinglés",
        .home_section_recent: "Récents",
        .home_section_shared: "Partagés avec moi",
        ...
        .home_pin: "Épingler",
        .home_unpin: "Désépingler",
        .home_dismiss_error: "Ignorer l’erreur",
        .home_document_options: "Options du document",
        ...
        .home_error_favorite: "Impossible de mettre à jour le favori. Veuillez réessayer.",
        ...
        .shared_subtitle_by: "%@ · Partagé %@",
        .shared_footer_with:
            "Documents auxquels d’autres personnes vous ont invité. Votre accès dépend de votre rôle sur chacun d’eux.",
        .shared_footer_by:
            "Documents que vous possédez ou avez partagés. Gérez qui peut les voir depuis la fenêtre de partage de chaque document.",
        ...
        .docrow_more_options: "Plus d’options",
        ...
        .options_copy_markdown: "Copier en Markdown",
        .options_duplicate: "Dupliquer",
        ...
        .options_error_duplicate: "Impossible de dupliquer le document. Veuillez réessayer.",
        ...
        .editor_tree_close: "Fermer les pages",
        .editor_tree_empty: "Aucune sous-page pour le moment. Ajoutez-en une pour organiser ce document.",
        .editor_tree_new_page: "Nouvelle page",
