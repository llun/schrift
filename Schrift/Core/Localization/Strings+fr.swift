...
enum Strings_fr {
    static let table: [L10nKey: String] = [
        ...
        .editor_attachment_pending: "En attente d'envoi",
        ...
        .editor_image_external: "Image externe · Appuyez pour charger",
        .editor_image_external_a11y: "Image externe depuis %@. Appuyez pour charger.",
        .editor_attachment_downloading: "Téléchargement…",
        ...
        .editor_error_add_file: "Impossible d'ajouter le fichier. Veuillez réessayer.",
        .editor_error_file_too_large: "Ce fichier est trop volumineux.",
        .editor_slash_file: "Fichier",
        .editor_uploading_file: "Envoi du fichier…",
        .editor_uploading_file_a11y: "Envoi du fichier",
        ...
        .editor_checklist_state_not_done_a11y: "Non terminé",
        ...
        // Pages tree drawer
        .pages_title: "Pages",
        .pages_open: "Afficher les pages",
        .pages_close: "Fermer les pages",
        .pages_expand: "Développer",
        .pages_collapse: "Réduire",
        .pages_new: "Nouvelle page",
        .pages_empty: "Aucune sous-page pour le moment. Ajoutez-en une pour organiser ce document.",
        .pages_error_load: "Impossible de charger les pages. Veuillez réessayer.",
        .pages_error_create: "Impossible d’ajouter la page. Veuillez réessayer.",
