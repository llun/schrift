...
struct SignedInUserStore {
    ...
    /// Called at three moments, all through `SessionStore.forgetSignedInIdentity`: when a web
    /// login hands over its cookies (`noteSessionCookiesReplaced`), at sign-in, and at sign-out.
